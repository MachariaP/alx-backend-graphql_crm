# Generated by Django 6.0 on 2025-12-15 10:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Invalid phone format. Examples: +1234567890 or 123-456-7890', regex='^(\\+?\\d{1,4}[-.\\s]?\\(?\\d{1,3}\\)?[-.\\s]?\\d{1,4}[-.\\s]?\\d{1,4}[-.\\s]?\\d{1,9})$')])),
            ],
        ),
        migrations.CreateModel(
            name='Product',
